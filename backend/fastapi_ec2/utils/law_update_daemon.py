...
from utils.law_service import get_law_dict, get_law_clauses
...
class LawUpdateDaemon:
    ...
    def _fetch_verbose(self, url: str, timeout: int, name_invoker: str = "_fetch_verbose") -> Optional[requests.Response]:
