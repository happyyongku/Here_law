...
from llama_cpp import ChatCompletionResponseMessage
...
llm = Llama31KorChatbot(n_ctx=4000, n_batch = 512, n_gpu_layers =-1)
...
async def chat_endpoint(request: Llama31KorChatRequest):
    try:
        ...
        # Add optional parameters only if they are not None TODO 더 General하게
        optional_params = [
